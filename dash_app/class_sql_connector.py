...
class SQLConnection():
    ...
    def delete_tables(self):
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.dbo.OrderItem;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.dbo.Order_firstdb;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.dbo.Customer;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.dbo.Product;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.dbo.Supplier;')
        self.cursor.commit()
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.SQL.OrderItem;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.SQL.Order_firstdb;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.SQL.Customer;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.SQL.Product;')
        self.cursor.execute('DROP TABLE IF EXISTS '+self.main_db+'.SQL.Supplier;')
        self.cursor.commit()
    ...
    def transfer_schema(self):
        ...
        try:
            ...
            self.connection2.execute('DROP SCHEMA IF EXISTS ' + schema_name + ';')
